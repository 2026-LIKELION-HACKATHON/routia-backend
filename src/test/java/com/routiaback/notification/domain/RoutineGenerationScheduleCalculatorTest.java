...
class RoutineGenerationScheduleCalculatorTest {
    ...
    @Test void schedulesUnconfiguredUserAtSixInSeoulWithoutNotification(){var target=calculator.nextDefault("Asia/Seoul",Instant.parse("2026-08-15T00:00:00Z"));assertThat(target.routineDate()).isEqualTo(LocalDate.of(2026,8,16));assertThat(target.generationAt()).isEqualTo(Instant.parse("2026-08-15T21:00:00Z"));assertThat(target.notificationAt()).isNull();}
    ...
    @Test void disabledNotificationUsesDefaultGenerationEvenWhenTimeIsPreserved(){
        ...
        assertThat(next.generationAt()).isEqualTo(Instant.parse("2026-08-15T21:00:00Z"));
